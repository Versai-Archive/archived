...
class Server{
	...
	public function addOnlinePlayer(Player $player) : bool{
		...
		//to remove ip logged on addOnlinePlayer event
		$this->logger->info(TextFormat::AQUA . $player->getName() . TextFormat::RESET . "logged in with entity id " . (string) $player->getId());
