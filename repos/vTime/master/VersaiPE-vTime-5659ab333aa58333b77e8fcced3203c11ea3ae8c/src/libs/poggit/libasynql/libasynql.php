...
namespace Versai\vTime\libs\poggit\libasynql;

use InvalidArgumentException;
use pocketmine\plugin\PluginBase;
use pocketmine\utils\Terminal;
use pocketmine\utils\Utils;
use Versai\vTime\libs\poggit\libasynql\base\DataConnectorImpl;
use Versai\vTime\libs\poggit\libasynql\base\SqlThreadPool;
use Versai\vTime\libs\poggit\libasynql\mysqli\MysqlCredentials;
use Versai\vTime\libs\poggit\libasynql\mysqli\MysqliThread;
use Versai\vTime\libs\poggit\libasynql\sqlite3\Sqlite3Thread;
...
final class libasynql{
	...
	public static function detectPackaged() : void{
		self::$packaged = __CLASS__ !== 'Versai\vTime\libs\poggit\libasynql\libasynql';
