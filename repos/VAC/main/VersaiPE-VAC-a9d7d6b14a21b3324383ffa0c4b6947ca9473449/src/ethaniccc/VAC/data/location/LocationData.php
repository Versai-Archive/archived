...
final class LocationData {
	...
	public function __construct(
		...
		$this->receivedPos = $this->receivedPos->add($motion);
	}
	...
	public function tick(): void {
		if ($this->isTeleporting()) {
			...
			if ($this->newPosTickIncrements > 0) {
				$diff = $this->receivedPos->subtract($this->oldPos)->divide($this->newPosTickIncrements);
				$this->oldPos = clone $this->currentPos;
				$this->currentPos = $this->oldPos->add($diff);
			}
		}
