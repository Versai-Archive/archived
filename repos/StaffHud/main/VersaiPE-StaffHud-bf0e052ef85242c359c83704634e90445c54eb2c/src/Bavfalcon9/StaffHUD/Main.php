...
class Main extends PluginBase {
    ...
    private function loadCommands() {
        ...
        $this->addPerms([
            new Permission('StaffHUD.staffmode', 'Use /staff', Permission::DEFAULT_OP),
            new Permission('StaffHUD.staffmode.see', 'See others in staff mode.', Permission::DEFAULT_OP),
            new Permission('StaffHUD.staffmode.see_op', 'See others in staff mode.', Permission::DEFAULT_OP)
        ]);
    }
