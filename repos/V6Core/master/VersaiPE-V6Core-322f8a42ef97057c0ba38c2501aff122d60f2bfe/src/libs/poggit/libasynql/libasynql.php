...
namespace Versai\V6\libs\poggit\libasynql;

use InvalidArgumentException;
use pocketmine\plugin\PluginBase;
use pocketmine\utils\Terminal;
use pocketmine\utils\Utils;
use Versai\V6\libs\poggit\libasynql\base\DataConnectorImpl;
use Versai\V6\libs\poggit\libasynql\base\SqlThreadPool;
use Versai\V6\libs\poggit\libasynql\mysqli\MysqlCredentials;
use Versai\V6\libs\poggit\libasynql\mysqli\MysqliThread;
use Versai\V6\libs\poggit\libasynql\sqlite3\Sqlite3Thread;
...
final class libasynql{
	...
	public static function detectPackaged() : void{
		self::$packaged = __CLASS__ !== 'Versai\V6\libs\poggit\libasynql\libasynql';

		if(!self::$packaged && defined("pocketmine\\VERSION")){
			echo Terminal::$COLOR_YELLOW . "Warning: Use of unshaded libasynql detected. Debug mode is enabled. This may lead to major performance drop. Please use a shaded package in production. See https://Versai\V6\libs\poggit.pmmp.io/virion for more information.\n";
		}
	}
